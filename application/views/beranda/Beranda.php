										...
										<div class="posty">
											<div class="post-bar no-margin">
												...
												<div class="job_descp">
													...
													<p><?php echo $pos->post_sentence; ?> <a href="#" title="">view more</a></p>
													<ul class="skill-tags">
													...
													<ul>
														<li>
															<div class="comment-list">
																...
																<div class="comment">						
																<div class="usy-dt">
																<img src="<?php echo base_url('assets/images/upload/profile/'.$kom->user_ava)?>" alt="" height="50px" >
																<div class="usy-name">
																<h3><?php echo $kom->nama_lengkap; ?></h3>
																<span><img src="<?php echo base_url('assets/images/clock.png') ?>" alt="">3 min ago</span>
																</div>
																</div>
																<span><img src="images/clock.png" alt=""> 3 min ago</span>
																<p><?php echo $kom->komentar_post_sentence; ?></p>
