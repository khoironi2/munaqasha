...
<head>
	<meta charset="UTF-8">
	<title>Seting <?php echo $datauser->nama_lengkap ?></title>
									...
									<div class="acc-setting">
										...
										<form>
											<div class="cp-field">
												<h5>Nama lengkap</h5>
												<div class="cpp-fiel">
													<input type="text" value="<?php echo $datauser->nama_lengkap ?>" name="nama_lengkap" placeholder="full name">
											...
											<div class="cp-field">
												<h5>City</h5>
												<div class="cpp-fiel">
													<input type="text" value="<?php echo $datauser->city ?>" name="city" placeholder="city">
													<i class="fa fa-lock"></i>
												</div>
											</div>
											<div class="cp-field">
												<h5>Email</h5>
												<div class="cpp-fiel">
													<input type="text" value="<?php echo $datauser->email ?>" placeholder="email" readonly>
													<i class="fa fa-lock"></i>
												</div>
											</div>
											<div class="cp-field">
												<h5>Create date</h5>
												<div class="cpp-fiel">
													<input type="text" value="<?php echo $datauser->create_datetime ?>" placeholder="email" readonly >
													<i class="fa fa-lock"></i>
												</div>
											</div>
											<div class="cp-field">
