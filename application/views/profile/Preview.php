...
<head>
	<meta charset="UTF-8">
	<title><?php echo $preview->nama_lengkap ?></title>
						...
						<div class="row">
							<div class="col-lg-3">
								<div class="main-left-sidebar">
									...
									<?php if($preview->user_ava != "") { ?>
										<img src="<?php echo base_url('assets/images/upload/profile/'.$preview->user_ava)?>" alt="Gambar Profile" height="130px">
									<?php } else { ?>
							...
							<div class="col-lg-6">
								<div class="main-ws-sec">
									<div class="user-tab-sec rewivew">
										<h3><?php echo  $preview->nama_lengkap; ?></h3>
								...
								<?php foreach ($post as $pos) : ?>	
									...
									<div class="post-bar">
											<div class="post_topbar">
												<div class="usy-dt">
													<img src="<?php echo base_url('assets/images/upload/profile/') . $pos2->user_ava; ?>" alt="" height="50px" >
													<div class="usy-name">
														<h3><?php echo $pos2->nama_lengkap; ?></h3>
...
<div class="post-popup pst-pj">
			<div class="post-project">
				...
				<div class="post-project-fields">
					<?php echo form_open_multipart('profile/Profile/updateAva'); ?>    
						<div class="row">
							<div class="col-lg-12">
								<input type="file" name="avapelamar" id="file" >	
							</div>
