...
<head>
	<meta charset="UTF-8">
	<title><?php echo $this->session->userdata('nama_lengkap'); ?></title>
						...
						<div class="row">
							<div class="col-lg-3">
								<div class="main-left-sidebar">
									...
									<?php if($datauser->user_ava != "") { ?>
										<img src="<?php echo base_url('assets/images/upload/profile/'.$datauser->user_ava)?>" alt="Gambar Profile" height="130px">
									<?php } else { ?>
